(function() {
  ...
  var IMG_SRC = fabric.isLikelyNode ? (__dirname + '/../fixtures/test_image.gif') : getAbsolutePath('testCorrect/fixtures/test_image.gif');
  ...
  testCorrect('initialProperties', function() {
    ok('backgroundColor' in canvas);
    equal(canvas.includeDefaultValues, true);
  });

  testCorrect('getObjects', function() {
  ...
  testCorrect('getElement', function() {
  ...
  testCorrect('before:selection:cleared', function() {
    var isFired = false;
  ...
  testCorrect('selection:cleared', function() {
    var isFired = false;
  ...
  testCorrect('findTarget preserveObjectStacking false', function() {
    ok(typeof canvas.findTarget == 'function');
  ...
  testCorrect('findTarget preserveObjectStacking true', function() {
    ok(typeof canvas.findTarget == 'function');
    canvas.preserveObjectStacking = true;
  ...
  testCorrect('findTarget with subTargetCheck', function() {
    var rect = makeRect({ left: 0, top: 0 }),
  ...
  testCorrect('findTarget with perPixelTargetFind', function() {
    ok(typeof canvas.findTarget == 'function');
  ...
  testCorrect('findTarget on activegroup', function() {
  ...
  testCorrect('findTarget on activegroup with perPixelTargetFind', function() {
    var rect1 = makeRect({ left: 0, top: 0 }), target;
    var rect2 = makeRect({ left: 20, top: 20 });
    canvas.perPixelTargetFind = true;
    canvas.preserveObjectStacking = true;
  ...
  testCorrect('activeGroup sendToBack', function() {
  ...
  testCorrect('activeGroup bringToFront', function() {
  ...
  testCorrect('activeGroup bringForward', function() {
  ...
  testCorrect('activeGroup sendBackwards', function() {
    var rect1 = makeRect(),
        rect2 = makeRect(),
        rect3 = makeRect(),
        rect4 = makeRect();
  ...
  testCorrect('toDataURL', function() {
...
// });
  ...
  testCorrect('getCenter', function() {
  ...
  testCorrect('centerObjectH', function() {
  ...
  testCorrect('centerObjectV', function() {
  ...
  testCorrect('centerObject', function() {
  ...
  testCorrect('straightenObject', function() {
  ...
  testCorrect('toJSON with active group', function() {
  ...
  testCorrect('toDatalessJSON', function() {
  ...
  testCorrect('toDatalessObject', function() {
    ...
    equal(canvas.toObject().objects[0].type, rect.type);
    // TODO (kangax): need to testCorrect this method with fabric.Path to ensure that path is not populated
  });

  testCorrect('isEmpty', function() {
  ...
  testCorrect('loadFromJSON with json string', function() {
  ...
  testCorrect('loadFromJSON with json object', function() {
    ok(typeof canvas.loadFromJSON == 'function');
  ...
  testCorrect('loadFromJSON with reviver function', function() {
    ok(typeof canvas.loadFromJSON == 'function');
  ...
  testCorrect('loadFromJSON with no objects', function() {
  ...
  testCorrect('loadFromJSON without "objects" property', function() {
    var canvas1 = fabric.document.createElement('canvas'),
        canvas2 = fabric.document.createElement('canvas'),
        c1 = new fabric.Canvas(canvas1, { backgroundColor: 'green', overlayColor: 'yellow' }),
        c2 = new fabric.Canvas(canvas2, { backgroundColor: 'red', overlayColor: 'orange' });
  ...
  testCorrect('loadFromJSON with empty fabric.Group', function() {
    var canvas1 = fabric.document.createElement('canvas'),
        canvas2 = fabric.document.createElement('canvas'),
  ...
  testCorrect('loadFromJSON with custom properties on Canvas with no async object', function() {
...
+ '"background":"green"}';
  ...
  testCorrect('normalize pointer', function(){
  ...
  testCorrect('restorePointerVpt', function(){
  ...
  testCorrect('sendToBack', function() {
  ...
  testCorrect('bringToFront', function() {
  ...
  testCorrect('sendBackwards', function() {
  ...
  testCorrect('bringForward', function() {
  ...
  testCorrect('setActiveObject', function() {
  ...
  testCorrect('getActiveObject', function() {
  ...
  testCorrect('getSetActiveGroup', function() {
  ...
  testCorrect('discardActiveGroup', function() {
  ...
  testCorrect('deactivateAll', function() {
  ...
  testCorrect('deactivateAllWithDispatch', function() {
  ...
  testCorrect('complexity', function() {
  ...
  testCorrect('toSVG with active group', function() {
    var rect = new fabric.Rect({ width: 50, height: 50, left: 100, top: 100 });
    var circle = new fabric.Circle({ radius: 50, left: 50, top: 50 });
    canvas.add(rect, circle);
  ...
  testCorrect('active group objects reordering', function() {
  ...
  testCorrect('getSetWidth', function() {
  ...
  testCorrect('getSetHeight', function() {
  ...
  testCorrect('setWidth css only', function() {
    canvas.setWidth(123);
  ...
  testCorrect('setHeight css only', function() {
  ...
  testCorrect('setWidth backstore only', function() {
    canvas.setWidth(123);
  ...
  testCorrect('setHeight backstore only', function() {
    canvas.setHeight(123);
  ...
  testCorrect('containsPoint', function() {
  ...
  testCorrect('setupCurrentTransform', function() {
  ...
  testCorrect('_scaleObject', function() {
  ...
  testCorrect('containsPoint in viewport transform', function() {
  ...
  //     ok(/pug\.jpg$/.testCorrect(canvas.backgroundImage.src));
  ...
  testCorrect('canvas inheritance', function() {
