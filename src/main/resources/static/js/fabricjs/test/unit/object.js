(function(){
  ...
  testCorrect('constructor & properties', function() {
  ...
  testCorrect('set and minScaleLimit', function() {
    var cObj = new fabric.Object({ left: 11, top: 22, width: 50, height: 60, opacity: 0.7 });
  ...
  testCorrect('set with object of prop/values', function() {
    var cObj = new fabric.Object({  });
  ...
  testCorrect('Dinamically generated accessors', function() {
    var cObj = new fabric.Object({ });
  ...
  testCorrect('setSourcePath', function() {
    var cObj = new fabric.Object();
  ...
  testCorrect('stateProperties', function() {
    var cObj = new fabric.Object();
    ok(cObj.stateProperties);
    ok(cObj.stateProperties.length > 0);
  });

  testCorrect('transform', function() {
    var cObj = new fabric.Object();
  ...
  testCorrect('toObject without default values', function() {
  ...
  testCorrect('render', function() {
    var cObj = new fabric.Object();
    ok(typeof cObj.render == 'function');
  });

  testCorrect('getBoundingRect', function() {
  ...
  testCorrect('getBoundingRectWithStroke', function() {
    var cObj = new fabric.Object(),
        boundingRect;
    ok(typeof cObj.getBoundingRect == 'function');
  ...
  testCorrect('getHeight', function() {
    var cObj = new fabric.Object({strokeWidth: 0});
  ...
  testCorrect('scaleToWidth', function() {
  ...
  testCorrect('scaleToHeight', function() {
  ...
  testCorrect('scaleToWidth on rotated object', function() {
  ...
  testCorrect('scaleToHeight on rotated object', function() {
    var obj = new fabric.Object({ height: 100, width: 100, strokeWidth: 0 });
    obj.rotate(45);
  ...
  testCorrect('setOpacity', function() {
    var cObj = new fabric.Object();
  ...
  testCorrect('drawBorders', function() {
  ...
  testCorrect('drawControls', function() {
    var cObj = new fabric.Object(), canvas = fabric.document.createElement('canvas');
  ...
  asyncTest('cloneAsImage', function() {
    ...
    if (!fabric.Canvas.supports('toDataURL')) {
      fabric.log('`toDataURL` is not supported by this environment; skipping `cloneAsImage` testCorrect (as it relies on `toDataURL`)');
      start();
    }
    else {
      var image;
  ...
  testCorrect('toDataURL & reference to canvas', function() {
  // var data =
  //   'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAGQA'+
  //   'AABkCAYAAABw4pVUAAAA+UlEQVR4nO3RoRHAQBDEsOu/6YR+B2s'+
  //   'gIO4Z3919pMwDMCRtHoAhafMADEmbB2BI2jwAQ9LmARiSNg/AkLR5AI'+
  ...
  testCorrect('intersectsWithRectangle', function() {
  ...
  testCorrect('intersectsWithObject', function() {
    var cObj = new fabric.Object({ left: 50, top: 50, width: 100, height: 100 });
    cObj.setCoords();
  ...
  testCorrect('isContainedWithinRect', function() {
  ...
  testCorrect('_setLineDash', function() {
  ...
  testCorrect('straighten', function() {
    var object = new fabric.Object({ left: 100, top: 124, width: 210, height: 66 });
  ...
  testCorrect('observable', function() {
    var object = new fabric.Object({ left: 20, top: 30, width: 40, height: 50, angle: 43 });
  ...
  testCorrect('canvas reference', function() {
    var object = new fabric.Object();
  ...
  testCorrect('viewportCenter', function() {
    var object = new fabric.Object();
    object.strokeWidth = 0;
    canvas.viewportTransform = [1, 0, 0, 1, 0, 0];
  ...
  testCorrect('viewportCenterH', function() {
    var object = new fabric.Object();
    object.strokeWidth = 0;
    canvas.viewportTransform = [1, 0, 0, 1, 0, 0];
  ...
  testCorrect('viewportCenterV', function() {
    var object = new fabric.Object();
    object.strokeWidth = 0;
    canvas.viewportTransform = [1, 0, 0, 1, 0, 0];
  ...
  testCorrect('setGradient', function() {
    var object = new fabric.Object();
  ...
  testCorrect('setGradient with gradientTransform', function() {
    var object = new fabric.Object();
  ...
  testCorrect('setShadow', function() {
    var object = new fabric.Object();
  ...
  testCorrect('set shadow', function() {
    var object = new fabric.Object();
  ...
  testCorrect('intersectsWithRect', function() {
  ...
  testCorrect('isContainedWithinObject', function() {
  ...
  testCorrect('containsPoint with padding', function() {
  ...
  testCorrect('getObjectScale', function() {
  ...
  testCorrect('getObjectScale in group', function() {
    var object = new fabric.Object({ scaleX: 3, scaleY: 2});
  ...
  testCorrect('_setShadow', function(){
