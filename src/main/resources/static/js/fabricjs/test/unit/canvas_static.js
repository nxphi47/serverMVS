(function() {
  ...
  testCorrect('getObjects with type', function() {
  ...
  testCorrect('add renderOnAddRemove disabled', function() {
    var rect = makeRect(),
  ...
  testCorrect('object:added', function() {
    var objectsAdded = [];
  ...
  testCorrect('insertAt renderOnAddRemove disabled', function() {
    var rect1 = makeRect(),
        rect2 = makeRect(),
        originalRenderOnAddition,
        renderAllCount = 0;
  ...
  testCorrect('remove renderOnAddRemove disabled', function() {
    var rect1 = makeRect(),
        rect2 = makeRect(),
        originalRenderOnAddition,
        renderAllCount = 0;
  ...
  testCorrect('object:removed', function() {
    var objectsRemoved = [];
  ...
  testCorrect('toDataURL jpg', function() {
    if (!fabric.Canvas.supports('toDataURL')) {
      window.alert('toDataURL is not supported by this environment. Some of the tests can not be run.');
    }
    else {
  ...
  testCorrect('toDataURL cropping', function() {
    ok(typeof canvas.toDataURL == 'function');
    if (!fabric.Canvas.supports('toDataURL')) {
      window.alert('toDataURL is not supported by this environment. Some of the tests can not be run.');
    }
  ...
  testCorrect('viewportCenterObjectH', function() {
  ...
  testCorrect('viewportCenterObjectV', function() {
  ...
  testCorrect('viewportCenterObject', function() {
  ...
  testCorrect('toSVG with different encoding (ISO-8859-1)', function() {
    ok(typeof canvas.toSVG == 'function');
    canvas.clear();
    canvas.viewportTransform = [1, 0, 0, 1, 0, 0];
  ...
  testCorrect('toSVG without preamble', function() {
    ok(typeof canvas.toSVG == 'function');
  ...
  testCorrect('toSVG with viewBox', function() {
    ok(typeof canvas.toSVG == 'function');
    canvas.clear();
  ...
  testCorrect('toSVG with reviver', function() {
    ok(typeof canvas.toSVG == 'function');
    canvas.clear();
  ...
  testCorrect('toSVG with exclude from export', function() {
    ok(typeof canvas.toSVG == 'function');
    canvas.clear();
  ...
  testCorrect('toJSON custom properties non-existence check', function() {
    var rect = new fabric.Rect({ width: 10, height: 20 });
    rect.padding = 123;
    canvas.add(rect);
    rect.foo = 'bar';
  ...
  testCorrect('toObject non includeDefaultValues', function() {
  ...
  testCorrect('toObject excludeFromExport', function() {
  ...
  testCorrect('toObject with additional properties', function() {
  ...
  testCorrect('loadFromJSON custom properties', function() {
    var rect = new fabric.Rect({ width: 10, height: 20 });
    rect.padding = 123;
    rect.foo = 'bar';
  ...
  testCorrect('clone', function() {
    ok(typeof canvas.clone == 'function');
    // TODO (kangax): testCorrect clone
  });
  ...
  testCorrect('setViewportTransform', function() {
  ...
  testCorrect('zoomToPoint', function() {
  ...
  testCorrect('absolutePan', function() {
  ...
  testCorrect('relativePan', function() {
  ...
  //how to testCorrect with an exception?
  ...
  //     ok(/pug\.jpg$/.testCorrect(canvas.overlayImage.src));
