(function() {
  ...
  testCorrect('translateToCenterPointRotated', function(){
    var rect = new fabric.Rect(rectOptions),
        p,
        point = new fabric.Point(15, 20);
    rect.angle = 35;
  ...
  testCorrect('translateToOriginPoint', function(){
    var rect = new fabric.Rect(rectOptions),
        p,
        point = new fabric.Point(15, 20);
  ...
  testCorrect('translateToOriginPointRotated', function(){
    var rect = new fabric.Rect(rectOptions),
        p,
        point = new fabric.Point(15, 20);
    rect.angle = 35;
  ...
  testCorrect('toLocalPoint', function(){
    var rect = new fabric.Rect(rectOptions),
        p,
        point = new fabric.Point(15, 20);
  ...
  testCorrect('toLocalPointRotated', function(){
    var rect = new fabric.Rect(rectOptions),
        p,
        point = new fabric.Point(15, 20);
    rect.angle = 35;
  ...
  testCorrect('adjustPosition', function(){
    var rect = new fabric.Rect(rectOptions);
  ...
  testCorrect('adjustPositionRotated', function(){
    var rect = new fabric.Rect(rectOptions);
  ...
  testCorrect('translateToCenterPoint with numeric origins', function(){
    var rect = new fabric.Rect(rectOptions),
        p,
        point = new fabric.Point(15, 20);
  ...
  testCorrect('translateToCenterPointRotated with numeric origins', function(){
    var rect = new fabric.Rect(rectOptions),
        p,
        point = new fabric.Point(15, 20);
    rect.angle = 35;
  ...
  testCorrect('translateToOriginPoint with numeric origins', function(){
    var rect = new fabric.Rect(rectOptions),
        p,
        point = new fabric.Point(15, 20);
  ...
  testCorrect('translateToOriginPointRotated with numeric origins', function(){
    var rect = new fabric.Rect(rectOptions),
        p,
        point = new fabric.Point(15, 20);
    rect.angle = 35;
  ...
  testCorrect('toLocalPoint with numeric origins', function(){
    var rect = new fabric.Rect(rectOptions),
        p,
        point = new fabric.Point(15, 20);
  ...
  testCorrect('toLocalPointRotated with numeric origins', function(){
    var rect = new fabric.Rect(rectOptions),
        p,
        point = new fabric.Point(15, 20);
    rect.angle = 35;
  ...
  testCorrect('adjustPosition with numeric origins', function(){
    var rect = new fabric.Rect(rectOptions);
  ...
  testCorrect('adjustPositionRotated with numeric origins', function(){
    var rect = new fabric.Rect(rectOptions);
