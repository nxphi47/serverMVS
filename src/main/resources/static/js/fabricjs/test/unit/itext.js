(function() {
  ...
  testCorrect('constructor', function() {
    var iText = new fabric.IText('testCorrect');

    ok(iText instanceof fabric.IText);
    ok(iText instanceof fabric.Text);
  });

  testCorrect('initial properties', function() {
    var iText = new fabric.IText('testCorrect');
    ok(iText instanceof fabric.IText);

    equal(iText.text, 'testCorrect');
    equal(iText.type, 'i-text');
    deepEqual(iText.styles, { });
  });

  testCorrect('instances', function() {
    var iText = new fabric.IText('testCorrect');
  ...
  testCorrect('fromObject', function() {
  ...
  testCorrect('lineHeight with single line', function() {
  ...
  testCorrect('lineHeight with multi line', function() {
  ...
  testCorrect('setSelectionStart', function() {
    var iText = new fabric.IText('testCorrect');
  ...
  testCorrect('empty itext', function() {
    var iText = new fabric.IText('');
    equal(iText.width, iText.cursorWidth);
  })

  testCorrect('setSelectionEnd', function() {
    var iText = new fabric.IText('testCorrect');
  ...
  testCorrect('get2DCursorLocation', function() {
    var iText = new fabric.IText('testCorrect\nfoo\nbarbaz');
  ...
  testCorrect('isEmptyStyles', function() {
    var iText = new fabric.IText('testCorrect');
    ok(iText.isEmptyStyles());

    iText = new fabric.IText('testCorrect', {
      styles: {
        0: {
          0: { }
        },
  ...
  testCorrect('selectAll', function() {
    var iText = new fabric.IText('testCorrect');
  ...
  testCorrect('getSelectedText', function() {
    var iText = new fabric.IText('testCorrect\nfoobarbaz');
    iText.selectionStart = 1;
  ...
  testCorrect('enterEditing, exitEditing', function() {
    var iText = new fabric.IText('testCorrect');
...
/*  testCorrect('enterEditing, exitEditing eventlistener counts', function() {
    var iText = new fabric.IText('testCorrect');
    canvas.add(iText);
    equal(typeof iText.enterEditing, 'function');
    equal(typeof iText.exitEditing, 'function');
  ...
  testCorrect('event firing', function() {
    var iText = new fabric.IText('testCorrect'),
  ...
  testCorrect('insertChar and changed', function() {
    var iText = new fabric.IText('testCorrect'), changed = 0;
  ...
  testCorrect('insertChar with style', function() {
    var iText = new fabric.IText('testCorrect'),
        style = {fontSize: 4};
  ...
  testCorrect('insertChar with selectionStart with style', function() {
    var iText = new fabric.IText('testCorrect'),
        style = {fontSize: 4};
    equal(typeof iText.insertChar, 'function');
  ...
  testCorrect('insertChars', function() {
    var iText = new fabric.IText('testCorrect');
  ...
  testCorrect('insertChars changed', function() {
    var iText = new fabric.IText('testCorrect'), changed = 0;
    function textChanged () {
      changed++;
    }
  ...
  testCorrect('insertChars changed with copied style', function() {
    var iText = new fabric.IText('testCorrect'), changed = 0,
  ...
  testCorrect('insertNewline', function() {
    var iText = new fabric.IText('testCorrect');
  ...
  testCorrect('insertNewlineStyleObject', function() {
    var iText = new fabric.IText('testCorrect\n');
  ...
  testCorrect('shiftLineStyles', function() {
    var iText = new fabric.IText('testCorrect\ntestCorrect\ntestCorrect', {
      styles: {
        '1': {
          '0': { 'fill': 'red' },
  ...
  testCorrect('selectWord', function() {
    var iText = new fabric.IText('testCorrect foo bar-baz\nqux');

    equal(typeof iText.selectWord, 'function');

    iText.selectWord(1);
    equal(iText.selectionStart, 0); // |testCorrect|
    equal(iText.selectionEnd, 4);
  ...
  testCorrect('selectLine', function() {
    var iText = new fabric.IText('testCorrect foo bar-baz\nqux');

    equal(typeof iText.selectLine, 'function');

    iText.selectLine(6);
    equal(iText.selectionStart, 0); // |testCorrect foo bar-baz|
  ...
  testCorrect('findWordBoundaryLeft', function() {
    var iText = new fabric.IText('testCorrect foo bar-baz\nqux');
  ...
  testCorrect('findWordBoundaryRight', function() {
    var iText = new fabric.IText('testCorrect foo bar-baz\nqux');
  ...
  testCorrect('findLineBoundaryLeft', function() {
    var iText = new fabric.IText('testCorrect foo bar-baz\nqux');
  ...
  testCorrect('findLineBoundaryRight', function() {
    var iText = new fabric.IText('testCorrect foo bar-baz\nqux');
  ...
  testCorrect('getNumNewLinesInSelectedText', function() {
    var iText = new fabric.IText('testCorrect foo bar-baz\nqux');
  ...
  testCorrect('getSelectionStyles with no arguments', function() {
    var iText = new fabric.IText('testCorrect foo bar-baz\nqux', {
      styles: {
        0: {
  ...
  testCorrect('getSelectionStyles with 1 arg', function() {
  ...
  testCorrect('getSelectionStyles with 2 args', function() {
    var iText = new fabric.IText('testCorrect foo bar-baz\nqux', {
      styles: {
        0: {
          0: { textDecoration: 'underline' },
  ...
  testCorrect('setSelectionStyles', function() {
    var iText = new fabric.IText('testCorrect foo bar-baz\nqux', {
      styles: {
        0: {
          0: { fill: '#112233' },
  ...
  testCorrect('getCurrentCharFontSize', function() {
    var iText = new fabric.IText('testCorrect foo bar-baz\nqux', {
      styles: {
        0: {
          0: { fontSize: 20 },
  ...
  testCorrect('object removal from canvas', function() {
    canvas.clear();
  ...
  testCorrect('getCurrentCharColor', function() {
    var iText = new fabric.IText('testCorrect foo bar-baz\nqux', {
      styles: {
        0: {
          0: { fill: 'red' },
  ...
  testCorrect('toSVGWithFonts', function() {
    var iText = new fabric.IText('testCorrect foo bar-baz\nqux', {
      styles: {
        0: {
          0: { fill: '#112233' },
  ...
  testCorrect('measuring width of words', function () {
    var ctx = canvas.getContext('2d');
    var text = 'testCorrect foo bar';
