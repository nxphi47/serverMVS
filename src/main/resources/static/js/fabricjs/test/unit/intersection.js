(function() {
  ...
  testCorrect('appendPoint', function(){
  ...
  testCorrect('appendPoints', function(){
    var point = new fabric.Point(1, 1);
    var intersection = new fabric.Intersection();
  ...
  testCorrect('intersectLineLine simple intersection', function(){
  ...
  testCorrect('intersectLineLine parallel', function(){
  ...
  testCorrect('intersectLineLine coincident', function(){
    var p1 = new fabric.Point(0, 0), p2 = new fabric.Point(0, 10),
  ...
  testCorrect('intersectLineLine coincident but different', function(){
    var p1 = new fabric.Point(0, 0), p2 = new fabric.Point(0, 10),
  ...
  testCorrect('intersectLineLine no intersect', function(){
    var p1 = new fabric.Point(0, 0), p2 = new fabric.Point(0,10),
  ...
  testCorrect('intersectLinePolygon', function(){
  ...
  testCorrect('intersectLinePolygon in one point', function(){
  ...
  testCorrect('intersectLinePolygon on a polygon segment', function(){
  ...
  testCorrect('intersectPolygonPolygon not intersecting', function(){
  ...
  testCorrect('intersectPolygonPolygon intersecting', function(){
  ...
  testCorrect('intersectPolygonRectangle intersecting', function(){
  ...
  testCorrect('intersectPolygonRectangle not intersecting', function(){
