(function() {
  ...
  testCorrect('saveCoords', function() {
    var group = makeGroupWith2Objects();
  ...
  testCorrect('setObjectCoords', function(){
    var group = makeGroupWith2Objects();
  ...
  testCorrect('forEachObject', function() {
    var group = makeGroupWith2Objects();
  ...
  testCorrect('get with locked objects', function() {
    var group = makeGroupWith2Objects();
  ...
  testCorrect('z-index methods with group objects', function() {
  ...
  testCorrect('group reference on an object', function() {
    var group = makeGroupWith2Objects();
  ...
  testCorrect('canvas property propagation', function() {
  ...
  testCorrect('testCorrect group transformMatrix', function() {
