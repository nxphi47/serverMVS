(function(){
  ...
  testCorrect('parseAttributes', function() {
  ...
  testCorrect('parseAttributesNoneValues', function() {
    var element = fabric.document.createElement('path');
  ...
  testCorrect('parseAttributesFillRule', function() {
    var element = fabric.document.createElement('path');
  ...
  testCorrect('parseAttributesFillRuleWithoutTransformation', function() {
    var element = fabric.document.createElement('path');
  ...
  testCorrect('parseAttributesTransform', function() {
    var element = fabric.document.createElement('path');
  ...
  testCorrect('parseAttributesWithParent', function() {
    var element = fabric.document.createElement('path');
  ...
  testCorrect('parseAttributesWithGrandParentSvg', function() {
    var element = fabric.document.createElement('path'),
  ...
  testCorrect('parseStyleAttribute', function() {
  ...
  testCorrect('parseStyleAttribute with one pair', function() {
    var element = fabric.document.createElement('path');
  ...
  testCorrect('parseStyleAttribute with trailing spaces', function() {
    var element = fabric.document.createElement('path');
  ...
  testCorrect('parseStyleAttribute with value normalization', function() {
    var element = fabric.document.createElement('path');
  ...
  testCorrect('parseStyleAttribute with short font declaration', function() {
    var element = fabric.document.createElement('path');
  ...
  testCorrect('parseAttributes (style to have higher priority than attribute)', function() {
    var element = fabric.document.createElement('path');
  ...
  testCorrect('parseAttributes stroke-opacity and fill-opacity', function() {
    var element = fabric.document.createElement('path');
  ...
  testCorrect('parsePointsAttribute', function() {
  ...
  testCorrect('parseTransformAttribute', function() {
    var parsedValue;
  ...
  testCorrect('parseNestedTransformAttribute', function() {
    var element = fabric.document.createElement('path');
    var parent = fabric.document.createElement('g');
    parent.appendChild(element);
  ...
  testCorrect('opacity attribute', function() {
  ...
  testCorrect('fill-opacity attribute with fill attribute', function() {
  ...
  testCorrect('fill-opacity attribute without fill attribute', function() {
    var el = fabric.document.createElement('rect');
    var opacityValue = Math.random().toFixed(2);
  ...
  testCorrect('fill-opacity attribute with fill none', function() {
    var el = fabric.document.createElement('rect');
    var opacityValue = Math.random().toFixed(2);
  ...
  testCorrect('stroke-opacity attribute with stroke attribute', function() {
    var el = fabric.document.createElement('rect');
    var opacityValue = Math.random().toFixed(2);
  ...
  testCorrect('stroke-opacity attribute without stroke attribute', function() {
    var el = fabric.document.createElement('rect');
    var opacityValue = Math.random().toFixed(2);
  ...
  testCorrect('stroke-opacity attribute with stroke none', function() {
    var el = fabric.document.createElement('rect');
    var opacityValue = Math.random().toFixed(2);
  ...
  testCorrect('getCssRule', function() {
  ...
  testCorrect('getCssRule with same selectors', function() {
