(function() {
  ...
  testCorrect('initializing with object', function() {
    ok(fabric.Shadow);
  ...
  testCorrect('initializing with string', function() {
    ok(fabric.Shadow);
  ...
  testCorrect('clone with affectStroke', function() {
  ...
  testCorrect('toObject without default value', function() {
    var shadow = new fabric.Shadow();
  ...
  testCorrect('toSVG with flipped object', function() {
    // reset uid
    fabric.Object.__uid = 0;
  ...
  testCorrect('toSVG with rotated object', function() {
    // reset uid
    fabric.Object.__uid = 0;
  ...
  testCorrect('toSVG with rotated flipped object', function() {
    // reset uid
    fabric.Object.__uid = 0;
