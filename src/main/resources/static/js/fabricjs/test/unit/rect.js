(function() {
  ...
  testCorrect('fabric.Rect.fromObject', function() {
  ...
  testCorrect('fabric.Rect.fromElement', function() {
  ...
  testCorrect('fabric.Rect.fromElement with custom attributes', function() {
  ...
  testCorrect('clone with rounded corners', function() {
  ...
  testCorrect('toSVG with rounded corners', function() {
  ...
  testCorrect('toSVG with alpha colors fill', function() {
  ...
  testCorrect('toSVG with id', function() {
  ...
  testCorrect('toSVG with alpha colors stroke', function() {
