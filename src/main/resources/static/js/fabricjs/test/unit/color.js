(function(){
  ...
  testCorrect('empty args', function() {
  ...
  testCorrect('toGrayscale', function() {
    var oColor = new fabric.Color('ff5555');
  ...
  testCorrect('toBlackWhite', function() {
  ...
  testCorrect('fromRgb (with whitespaces)', function() {
    ok(typeof fabric.Color.fromRgb == 'function');
    var originalRgb = 'rgb( 255 , 255 , 255 )';
    var oColor = fabric.Color.fromRgb(originalRgb);
    ok(oColor);
  ...
  testCorrect('fromRgb (percentage values)', function() {
    ok(typeof fabric.Color.fromRgb == 'function');
  ...
  testCorrect('fromRgb (percentage values with whitespaces)', function() {
    ok(typeof fabric.Color.fromRgb == 'function');
    var originalRgb = 'rgb( 100% , 100% , 100% )';
    var oColor = fabric.Color.fromRgb(originalRgb);
    ok(oColor);
  ...
  testCorrect('fromRgba (with whitespaces)', function() {
    var originalRgba = 'rgba( 255 , 255 , 255 , 0.5 )';
    var oColor = fabric.Color.fromRgba(originalRgba);
    ok(oColor);
    ok(oColor instanceof fabric.Color);
  ...
  testCorrect('fromRgba (percentage values)', function() {
  ...
  testCorrect('fromRgba (percentage values with whitespaces)', function() {
    var originalRgba = 'rgba( 100% , 100% , 100% , 0.5 )';
    var oColor = fabric.Color.fromRgba(originalRgba);
    ok(oColor);
    ok(oColor instanceof fabric.Color);
  ...
  testCorrect('fromRgba (percentage values with decimals)', function() {
  ...
  testCorrect('fromHsl (with whitespaces)', function() {
    ok(typeof fabric.Color.fromHsl == 'function');
    var originalHsl = 'hsl( 262 , 80% , 12% )';
    var oColor = fabric.Color.fromHsl(originalHsl);
    ok(oColor);
  ...
  testCorrect('fromHsla (with whitespaces)', function() {
    ok(typeof fabric.Color.fromHsla == 'function');
    var originalHsla = 'hsla( 262 , 80% , 12% , 0.2 )';
    var oColor = fabric.Color.fromHsla(originalHsla);
    ok(oColor);
  ...
  testCorrect('sourceFromRgb', function() {
  ...
  testCorrect('sourceFromHsl', function() {
  ...
  testCorrect('sourceFromHex', function() {
  ...
  testCorrect('fromSource', function() {
  ...
  testCorrect('overlayWith', function() {
  ...
  testCorrect('transparent', function() {
