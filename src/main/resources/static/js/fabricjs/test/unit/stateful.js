(function(){
  ...
  testCorrect('hasStateChanged', function() {
  ...
  testCorrect('saveState', function() {
    var cObj = new fabric.Object();
  ...
  testCorrect('saveState with extra props', function() {
    var cObj = new fabric.Object();
    cObj.prop1 = 'a';
    cObj.prop2 = 'b';
    cObj.left = 123;
  ...
  testCorrect('saveState with array', function() {
  ...
  testCorrect('saveState with fabric class gradient', function() {
    var cObj = new fabric.Object();
  ...
  testCorrect('savestate with custom property set', function() {
    var cObj = new fabric.Object();
