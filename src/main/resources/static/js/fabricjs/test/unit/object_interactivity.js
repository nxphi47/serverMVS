(function() {
  ...
  testCorrect('isControlVisible', function(){
    ok(fabric.Object);
  ...
  testCorrect('setControlVisible', function(){
    ok(fabric.Object);
  ...
  testCorrect('setControlsVisibility', function(){
    ok(fabric.Object);
  ...
  testCorrect('_setCornerCoords', function(){
  ...
  testCorrect('_findTargetCorner', function(){
  ...
  testCorrect('_calculateCurrentDimensions', function(){
  ...
  testCorrect('_getTransformedDimensions', function(){
    var cObj = new fabric.Object({ width: 10, height: 15, strokeWidth: 0 }), dim;
  ...
  testCorrect('_getNonTransformedDimensions', function(){
    var cObj = new fabric.Object({ width: 10, height: 15, strokeWidth: 0 }), dim;
