...
testCorrect('fabric.Observable exists', function() {
...
testCorrect('fire + observe', function() {
  var foo = { };
...
testCorrect('stopObserving', function() {
  var foo = { };
  fabric.util.object.extend(foo, fabric.Observable);
...
testCorrect('stopObserving without handler', function() {
  var foo = { };
  fabric.util.object.extend(foo, fabric.Observable);
...
testCorrect('stopObserving multiple handlers', function() {
  var foo = { };
  fabric.util.object.extend(foo, fabric.Observable);
...
testCorrect('stopObserving all events', function() {
  var foo = { };
  fabric.util.object.extend(foo, fabric.Observable);
...
testCorrect('observe multiple handlers', function() {
  var foo = { };
  fabric.util.object.extend(foo, fabric.Observable);
...
testCorrect('event options', function() {
  var foo = { };
  fabric.util.object.extend(foo, fabric.Observable);
...
testCorrect('removal of past events', function() {
  var foo = { },
...
testCorrect('removal of past events inner loop', function() {
  var foo = { },
...
testCorrect('adding events', function() {
  var foo = { },
      event1Fired = false, event2Fired = false,
      event3Fired = false, event4Fired = false,
      handler1 = function() {
