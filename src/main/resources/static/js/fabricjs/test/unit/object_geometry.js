(function() {
  ...
  testCorrect('setCoords', function() {
  ...
  testCorrect('calcTransformMatrix', function(){
  ...
  testCorrect('_constrainScale', function(){
    var cObj = new fabric.Object({ width: 10, height: 15, strokeWidth: 0 });
