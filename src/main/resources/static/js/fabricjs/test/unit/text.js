(function() {
  ...
  testCorrect('_getFontDeclaration', function() {
    var text = createTextObject();
  ...
  testCorrect('set with "hash"', function() {
    var text = createTextObject();
  ...
  testCorrect('setFontSize', function(){
    var text = createTextObject();
  ...
  testCorrect('fabric.Text.fromElement with custom attributes', function() {
  ...
  testCorrect('empty fromElement', function() {
    ok(fabric.Text.fromElement() === null);
  });

  testCorrect('dimensions after text change', function() {
  ...
  testCorrect('dimensions without text', function() {
    var text = new fabric.Text('');
    equal(text.width, 2);
  });

  testCorrect('setting fontFamily', function() {
    var text = new fabric.Text('x');
    text.path = 'foobar.js';
  ...
  testCorrect('toSVG justified', function() {
