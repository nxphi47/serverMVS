(function(){
  ...
  testCorrect('fromElement', function() {
  ...
  testCorrect('straight lines may have 0 width or heigth', function() {
  ...
  testCorrect('changing x/y coords should update width/height', function() {
  ...
  testCorrect('stroke-width in a style', function() {
    var lineEl = fabric.document.createElement('line');
  ...
  // testCorrect('x1,y1 less than x2,y2 should work', function() {
  ...
  lineCoordsCases.forEach(function (c_) {
    testCorrect('stroke-less line coords ' + c_.description, function() {
  ...
  getLeftToOriginXCases.forEach(function (c_) {
    testCorrect('Line.getLeftToOriginX() ' + c_.description, function () {
      var line = new fabric.Line(
        c_.givenPoints,
  ...
  getTopToOriginYCases.forEach(function (c_) {
    testCorrect('Line._getTopToOriginY() ' + c_.description, function () {
      var line = new fabric.Line(
        c_.givenPoints,
