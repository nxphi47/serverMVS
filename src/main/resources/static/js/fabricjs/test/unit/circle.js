(function() {
  ...
  testCorrect('getRadiusX, getRadiusY', function() {
  ...
  testCorrect('setRadius', function() {
  ...
  testCorrect('set radius', function() {
  ...
  testCorrect('cloning and radius, width, height', function() {
    var circle = new fabric.Circle({ radius: 10, strokeWidth: 0});
    circle.scale(2);
