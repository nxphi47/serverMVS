(function() {
  ...
  testCorrect('constructor linearGradient', function() {
    ok(fabric.Gradient);
  ...
  testCorrect('constructor radialGradient', function() {
    ok(fabric.Gradient);
  ...
  testCorrect('properties linearGradient', function() {
    var gradient = createLinearGradient();
  ...
  testCorrect('properties radialGradient', function() {
    var gradient = createRadialGradient();
  ...
  testCorrect('toObject linearGradient', function() {
    var gradient = createLinearGradient();
  ...
  testCorrect('toObject radialGradient', function() {
    var gradient = createRadialGradient();
  ...
  testCorrect('toLive linearGradient', function() {
    var gradient = createLinearGradient();

    ok(typeof gradient.toLive == 'function');
  });

  testCorrect('toLive radialGradient', function() {
    var gradient = createRadialGradient();

    ok(typeof gradient.toLive == 'function');
  });

  testCorrect('fromElement linearGradient', function() {
  ...
  testCorrect('fromElement linearGradient with Infinity', function() {
    ok(typeof fabric.Gradient.fromElement == 'function');
  ...
  testCorrect('fromElement without stop', function() {
    ok(typeof fabric.Gradient.fromElement == 'function');
  ...
  testCorrect('fromElement with x1,x2,y1,2 linear', function() {
    ok(typeof fabric.Gradient.fromElement == 'function');
  ...
  testCorrect('fromElement with x1,x2,y1,2 radial', function() {
    ok(typeof fabric.Gradient.fromElement == 'function');
  ...
  testCorrect('fromElement with x1,x2,y1,2 radial userSpaceOnUse', function() {
    ok(typeof fabric.Gradient.fromElement == 'function');
  ...
  testCorrect('fromElement with x1,x2,y1,2 linear userSpaceOnUse', function() {
    ok(typeof fabric.Gradient.fromElement == 'function');
  ...
  testCorrect('fromElement radialGradient', function() {
    ok(typeof fabric.Gradient.fromElement == 'function');
  ...
  testCorrect('fromElement radialGradient with transform', function() {
    ok(typeof fabric.Gradient.fromElement == 'function');
  ...
  testCorrect('fromElement linearGradient colorStop attributes/styles', function() {
    ok(typeof fabric.Gradient.fromElement == 'function');
  ...
  testCorrect('fromElement radialGradient colorStop attributes/styles', function() {
    ok(typeof fabric.Gradient.fromElement == 'function');
  ...
  testCorrect('forObject linearGradient', function() {
  ...
  testCorrect('forObject radialGradient', function() {
    ok(typeof fabric.Gradient.forObject == 'function');
