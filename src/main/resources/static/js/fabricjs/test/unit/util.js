(function() {
  ...
  var IMG_URL = fabric.isLikelyNode
    ...
    : getAbsolutePath('testCorrect/fixtures/very_large_image.jpg');

  var IMG_URL_NON_EXISTING = 'http://www.google.com/non-existing';

  testCorrect('fabric.util.toFixed', function(){
  ...
  testCorrect('fabric.util.removeFromArray', function() {
  ...
  testCorrect('fabric.util.degreesToRadians', function(){
  ...
  testCorrect('fabric.util.radiansToDegrees', function(){
  ...
  testCorrect('fabric.util.getRandomInt', function() {
  ...
  testCorrect('fabric.util.falseFunction', function() {
    ok(typeof fabric.util.falseFunction == 'function');
    equal(fabric.util.falseFunction(), false);
  });

  testCorrect('String.prototype.trim', function() {
    ok(typeof String.prototype.trim == 'function');
    equal('\t\n   foo bar \n    \xA0  '.trim(), 'foo bar');
  });

  testCorrect('fabric.util.string.camelize', function() {
  ...
  testCorrect('fabric.util.string.escapeXml', function() {
  ...
  testCorrect('fabric.util.string.capitalize', function() {
  ...
  testCorrect('fabric.util.object.extend', function() {
  ...
  testCorrect('fabric.util.object.extend deep', function() {
    var extend = fabric.util.object.extend;
    var d = function() { };
    var destination = { x: 1 },
  ...
  testCorrect('fabric.util.object.clone', function() {
  ...
  testCorrect('Function.prototype.bind', function() {
  ...
  testCorrect('fabric.util.getById', function() {
  ...
  testCorrect('fabric.util.toArray', function() {
  ...
  testCorrect('fabric.util.makeElement', function() {
  ...
  testCorrect('fabric.util.addClass', function() {
  ...
  testCorrect('fabric.util.wrapElement', function() {
  ...
  testCorrect('fabric.util.makeElementUnselectable', function() {
    ...
    // not sure if it's a good idea to testCorrect implementation details here
    // functional testCorrect would probably make more sense
  ...
  testCorrect('fabric.util.makeElementSelectable', function() {
  ...
  testCorrect('fabric.loadSVGFromURL', function() {
  ...
  testCorrect('Array.prototype.indexOf', function() {
  ...
  testCorrect('Array.prototype.forEach', function() {
  ...
  testCorrect('Array.prototype.map', function() {
  ...
  testCorrect('Array.prototype.every', function() {
  ...
  testCorrect('Array.prototype.some', function() {
  ...
  testCorrect('Array.prototype.filter', function() {
  ...
  testCorrect('Array.prototype.reduce', function() {
  ...
  testCorrect('fabric.util.createClass', function() {
  ...
  if (!fabric.isLikelyNode) {
    testCorrect('fabric.util.setStyle', function() {
  ...
  // testCorrect('fabric.util.request', function() {
  // });

  // testCorrect('fabric.util.getPointer', function() {
  // });

  // testCorrect('fabric.util.addListener', function() {
  // });

  // testCorrect('fabric.util.removeListener', function() {
  // });

  testCorrect('fabric.util.drawDashedLine', function() {
  ...
  testCorrect('fabric.util.array.invoke', function() {
  ...
  testCorrect('fabric.util.array.min', function() {
  ...
  testCorrect('fabric.util.array.max', function() {
  ...
  testCorrect('fabric.util.populateWithProperties', function() {
  ...
  testCorrect('fabric.util.getFunctionBody', function() {
  ...
  testCorrect('resolveNamespace', function() {
  ...
  testCorrect('clearFabricFontCache', function() {
  ...
  testCorrect('parsePreserveAspectRatioAttribute', function() {
  ...
  testCorrect('multiplyTransformMatrices', function() {
  ...
  testCorrect('customTransformMatrix', function() {
  ...
  testCorrect('resetObjectTransform', function() {
  ...
  testCorrect('invertTransform', function() {
